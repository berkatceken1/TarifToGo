          ...
          <View style={{marginTop: 20, marginHorizontal: 25}}>
            <View style={styles.infoMain}>
              <View style={styles.infoCont}>
                ...
                <View style={styles.infoText}>
                  <Text style={styles.infoSmall_Text}>E-posta</Text>
            ...
            <View style={styles.infoMain}>
              <View style={styles.infoCont}>
                ...
                <View style={styles.infoText}>
                  <Text style={styles.infoSmall_Text}>Cinsiyet</Text>
            ...
            <View style={styles.infoMain}>
              <View style={styles.infoCont}>
                ...
                <View style={styles.infoText}>
                  <Text style={styles.infoSmall_Text}>Meslek</Text>
                  <Text style={styles.infoLarge_Text}>
                    {userData.profession==""||
            ...
            <View style={styles.infoMain}>
              <View style={styles.infoCont}>
                ...
                <View style={styles.infoText}>
                  <Text style={styles.infoSmall_Text}>Telefon</Text>
