    ...
    export default function HomeScreen() {
        ...
        async function fetchUserData() {
            ...
            axios.post('http://10.80.7.1:5001/userdetails', { token })
                .then(res => {
        ...
        useFocusEffect(
            useCallback(() => {
                async function checkGuest() {
                    ...
                    const parsedGuestStatus = JSON.parse(guestStatus);
                    setIsGuest(parsedGuestStatus);
    
                    if (!parsedGuestStatus) {
                        fetchUserData();
                    }
                    fetchCategories();
                    fetchRecipes();
            ...
            <View style={{ flex: 1, backgroundColor: 'white' }}>
                ...
                <ScrollView contentContainerStyle={{ paddingBottom: 50 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginHorizontal: 4, marginTop: 20, marginBottom: 2 }}>
                        ...
                        <View style={{flexDirection: 'row', justifyContent: 'center', marginLeft:8}}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('FoodBot')}>
                            <Image source={require('../../assets/images/foodbot.png')} style={{ height: 100, width: 100 }} />
                        </TouchableOpacity>
                    </View>
